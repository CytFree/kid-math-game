...
var TPL={
  ...
  mix:{mode:'mix',scenes:[
    {e:'🍬',s:'{n}有{a}个{e}，又买了{b}个{e}',op:'+'},
    {e:'🍎',s:'树上有{a}个{e}，又长了{b}个{e}',op:'+'},
    {e:'🍬',s:'{n}有{a}个{e}，给了朋友{b}个{e}',op:'-'},
    {e:'🍎',s:'有{a}个{e}，弄丢了{b}个{e}',op:'-'}
  ]},
  bigNum:{mode:'add',maxSum:10,scenes:[
    {e:'🎋',s:'{n}有{a}个{e}，又找到了{b}个{e}'},
    {e:'🍎',s:'树上有{a}个{e}，又长了{b}个{e}'}
  ]}
};
