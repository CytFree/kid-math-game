...
var AN={
  cat:{name:'小橘',emoji:'🐱',area:'home',teach:'add',personality:'活泼',items:['🐟'],
    scenes:{add:['{n}有{a}条🐟，妈妈又给了{b}条🐟','鱼缸里有{a}条🐟，又游来了{b}条🐟']},
  ...
  dog:{name:'旺财',emoji:'🐶',area:'home',teach:'sub',personality:'忠诚',items:['🦴'],
    scenes:{sub:['{n}有{a}根🦴，叼走了{b}根🦴','{n}埋了{a}根🦴，挖出了{b}根🦴']},
  ...
  rabbit:{name:'跳跳',emoji:'🐰',area:'orchard',teach:'addChain',personality:'胆小',items:['🥕'],
    scenes:{add:['{n}种了{a}个🥕，又种了{b}个🥕','{n}有{a}个🥕，朋友又给了{b}个🥕']},
  ...
  bear:{name:'团团',emoji:'🐻',area:'orchard',teach:'subChain',personality:'贪吃',items:['🍯'],
    scenes:{sub:['{n}有{a}罐🍯，吃了{b}罐🍯','{n}藏了{a}罐🍯，被拿走了{b}罐🍯']},
  ...
  fox:{name:'聪聪',emoji:'🦊',area:'park',teach:'mix',personality:'聪明',items:['🍇'],
    scenes:{add:['{n}有{a}颗🍇，又摘了{b}颗🍇','树上有{a}串🍇，又长了{b}串🍇'],sub:['{n}有{a}颗🍇，吃了{b}颗🍇','{n}有{a}串🍇，分给了朋友{b}串🍇']},
  ...
  panda:{name:'圆圆',emoji:'🐼',area:'castle',teach:'bigNum',personality:'慢吞吞',items:['🎋'],
    scenes:{add:['{n}有{a}根🎋，又长出了{b}根🎋','{n}有{a}根🎋，又找到了{b}根🎋']},
  ...
  dolphin:{name:'蓝蓝',emoji:'🐬',area:'beach',teach:'mix',personality:'活泼',items:['🐚'],
    scenes:{add:['{n}捡了{a}个🐚，海浪又冲上来{b}个🐚','沙滩上有{a}个🐚，又发现了{b}个🐚'],sub:['{n}有{a}个🐚，被海浪卷走了{b}个🐚','{n}捡了{a}个🐚，送给了朋友{b}个🐚']},
...
var TPL={
  add:{mode:'add',maxSum:10,scenes:[
    {e:'🍎',s:'有{a}个{e}，又来了{b}个{e}'},
    {e:'🍪',s:'有{a}个{e}，妈妈又给了{b}个{e}'}
  ]},
  sub:{mode:'sub',maxTotal:10,scenes:[
    {e:'🍎',s:'有{a}个{e}，给了朋友{b}个{e}'},
    {e:'🍪',s:'有{a}个{e}，吃了{b}个{e}'}
  ]},
  addChain:{mode:'ac',maxSum:10,scenes:[
    {e:'🍎',s:'有{a}个{e}，朋友又给了{b}个{e}'}
  ]},
  subChain:{mode:'sc',scenes:[
    {e:'🍎',s:'有{a}个{e}，用掉了{b}个{e}'}
  ]},
  mix:{mode:'mix',scenes:[
    {e:'🍬',s:'有{a}颗{e}，又买了{b}颗{e}',op:'+'},
    {e:'🍎',s:'有{a}个{e}，吃了{b}个{e}',op:'-'}
  ]},
  bigNum:{mode:'add',maxSum:10,scenes:[
    {e:'🍎',s:'有{a}个{e}，又找到了{b}个{e}'}
  ]}
};
